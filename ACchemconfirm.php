...
<body>
		...
		<center>
          ...
          <tr>
            <td>&nbsp;</td>
            <td>
             <h5>Please confirm your request for Air-Conditioner chemical service<h5>
            </td>
          </tr>
        </table width="300">
			<div>
				...
				<tr><td>
        <h5>Landmark</h5></td> <td><h5><b> <?php echo $_SESSION['landmark']; ?></b></h5></td></tr>
        <tr><td>  
				...
				<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr><td><form action="/your-server-side-code" method="POST">
<script
  ...
  data-zip-code="true">
					...
					<td><button><a href="/h2u/ACchemreq.php" class="button" style="vertical-align:middle"><span>Submit Request </span></a></button></td></tr></table></div>
		<br><br>
		</center> 
