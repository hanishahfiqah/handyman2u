...
<center>
<form>
	<h3>What problem(s) are you having? </h3>
      <div class="search-row">  
	<input type="checkbox" class="get_value" value="Clogged"><label>Clogged pipe/drain</label><br/>
    <input type="checkbox" class="get_value" value="Burst"><label>Burst </label><br/>
    <input type="checkbox" class="get_value" value="Leak"><label>Leak</label><br/>
	<input type="checkbox" class="get_value" value="Flooding"><label>Flooding</label><br/>
	<input type="checkbox" class="get_value" value="Other"><label>Other</label><br/>
</div>
...
<h4 id="result"></h4>
<br/>
<a href="/h2u/plumbSys.php" class="button" style="vertical-align:middle"><span>Next </span></a>
...
$(document).ready(function(){
	$('#submit').click(function(){
 		...
 		$('.get_value').each(function(){
 			if($(this).is(":checked"))
 			{
				 inthis.push($(this).val());
 			}
 		});
 		inthis = inthis.toString();
 		$.ajax({
 			url: "inthis.php",
 		method: "POST",
 		data:{inthis:inthis},
