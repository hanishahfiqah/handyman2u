                        ...
                        <div class="section"> 
                            <div id="list-type" class="proerty-th-list">
                                ...
                                <div class="col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        <div class="item-thumb">
                                            <a href="property-1.html" ><img src="assets/img/demo/Plumbing-Service-NYC.jpg"></a>
                                        </div>
                                        <div class="item-entry overflow">
                                            <h5><a href="property-1.html"> Plumbing Installation </a></h5>
                                ...
                                <div class="col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        <div class="item-thumb">
                                            <a href="plumbprob.php" ><img src="assets/img/demo/plumbing-services.jpg"></a>
                                        </div>
                                        <div class="item-entry overflow">
                                            <h5><a href="property-1.html"> Plumbing Repair </a></h5>
                                            <div class="dot-hr"></div>
                                            ...
                                            <div class="property-icon">
                                                    ...
                                                    <a href="#" class="button delete_user_car"></a>
                                                    <div class="dealer-action pull-right">  
                                                    <a href="http://localhost/h2u/plumbProb.php" class="button">Request</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
