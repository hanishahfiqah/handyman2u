...
if(isset($_POST['btn']))
{
    ...
    if(empty($_POST['serviceplace']) || empty($_POST['providepart'])|| empty($_POST['property'])|| empty($_POST['prefertime'])|| empty($_POST['servicedate']) || empty($_POST['emailform'])){
      $Error="<p class=\"err\">Fill the Required Fields</p>";
    } else {

  $serviceplace=mysqli_real_escape_string($db,$_POST['serviceplace']);
    $providepart = mysqli_real_escape_string($db, $_POST['providepart']);
  ...
  $sql="INSERT INTO plumbform(serviceplace,providepart,property,prefertime,servicedate,emailform,moredetails) VALUES('$serviceplace','$providepart' , '$property','$prefertime','$servicedate','$emailform','$moredetails')";
            mysqli_query($db,$sql);
            $_SESSION['message']="You are now logged in"; 
            $_SESSION['serviceplace']=$serviceplace;
             $_SESSION['providepart']=$providepart;
...
<body>
        ...
        <!-- <form action="ACchemform.php" method="post"> -->
          <form method="post" action="plumbform.php"> 
         <center>
          <table>
          <tr>
           ...
           <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
          <tr>
            <td><center>    Will you be providing the parts required?* </center></td>
            <td> 
              <input type="radio" name="providepart" value="Yes"/>Yes, I will be providing the parts
              <input type="radio" name="providepart" value="No"/>No. I need the plumber to provide it.
            </td>
          </tr>
          <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
          <tr>
