            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">Air Conditioner Servicing</h1>               
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="section"> 
                            <div id="list-type" class="proerty-th-list">
                                <div class="col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        <div class="item-thumb">
                                            <a href="property-1.html" ><img src="assets/img/demo/ACsupply&install.png"></a>
                                        </div>
                                        <div class="item-entry overflow">
                                            <h5><a href="property-1.html"> Aircond (Supply & Install) </a></h5>
                                            <div class="dot-hr"></div>
                                            <p style="display: none;">Our registered service provider ready to supply and install for you top brand air conditioner ...</p>
                                            <div class="property-icon">
                                                    <a href="submit-property.html" class="button"> </a>
                                                    <a href="#" class="button delete_user_car"></a>
                                                    <div class="dealer-action pull-right">  
                                                    <a href="property-1.html" class="button">Request</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        <div class="item-thumb">
                                            <a href="ACchemterms.php" ><img src="assets/img/demo/ACchemservice.jpg"></a>
                                        </div>
                                        <div class="item-entry overflow ">
                                            <h5><a href="ACchemterms.php"> Aircond Chemical Service </a></h5>
                                            <div class="dot-hr"></div>
                                            <p style="display: none;">Indoor & Outdoor, clean Drainage Pipe, compressor Health Check, refrigerant Top-up ...</p>
                                            <div class="property-icon">
                                                    <!--<a href="ACchemterms.php" class="button"> </a>
                                                    <a href="#" class="button delete_user_car"></a>-->
                                                    <div class="dealer-action pull-right">  
                                                    <a href="ACchemterms.php" class="button">Request</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        <div class="item-thumb">
                                            <a href="property-1.html" ><img src="assets/img/demo/Acinstall.jpg"></a>
                                        </div>
                                        <div class="item-entry overflow">
                                            <h5><a href="property-1.html"> Aircond Installation </a></h5>
                                            <div class="dot-hr"></div>
                                            <p style="display: none;">Get your air-conditioner bought but don't have time to install? Our service provider ready to help! ...</p>
                                            <div class="property-icon">
                                                    <a href="submit-property.html" class="button"> </a>
                                                    <a href="#" class="button delete_user_car"></a>
                                                    <div class="dealer-action pull-right">  
                                ...
                                <div class="col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        <div class="item-thumb">
                                            <a href="property-1.html" ><img src="assets/img/demo/ACrepair.jpg"></a>
                                        </div>
                                        <div class="item-entry overflow">
                                            <h5><a href="property-1.html"> Aircond Repair </a></h5>
                                            <div class="dot-hr"></div>
                                            <p style="display: none;"> Filter & evaporator surface cleaning, clear clogging in drainage, repair broken joints ...</p>
                                            <div class="property-icon">
                                                    <a href="submit-property.html" class="button"> </a>
                                                    <a href="#" class="button delete_user_car"></a>
                                                    <div class="dealer-action pull-right">  
